...
const LeftSideBar = () => {
  return (
    <section className="max-sm:hidden top-0 left-0 sticky flex flex-col justify-between shadow-light-300 dark:shadow-none p-6 pt-32 light-border border-0 lg:w-[266px] h-screen overflow-y-auto custom-scrollbar background-light900_dark200">
